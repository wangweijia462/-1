function Func=SolveCounter_2017_optimization(XX,Ry,Rh,tar_ry_2017,tar_rh_2017,A_2017,V_2017,c_od_2017,L_2017,H_2017,Lh_2017,Ph_2017,A_tar_2017,N_2017,F,Pry1,N,alpha,eta,kappa,sigma,rho,Pl_2017,Pry,Prh)
...
A_2017_new1 = (((1+tar_ry_2017_new).*Pry.* Ry + (1+tar_rh_2017_new).*Prh.* Rh + F).^rho).*(A_tar_2017.^(1-rho));
A_2017_new = real(A_2017_new1);
